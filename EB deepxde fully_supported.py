...
# Define boundary conditions for both ends fixed
...
bc3 = dde.icbc.DirichletBC(geom, lambda x: 0, boundary_r)  # y(1) = 0
bc4 = dde.icbc.NeumannBC(geom, lambda x: 0, boundary_r)    # y'(1) = 0
